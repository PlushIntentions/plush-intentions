  ...
  return (
    <div className="min-h-screen bg-plush-gradient flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl p-10 w-full max-w-md">
        ...
        <p className="text-gray-500 text-sm mb-6">Access your work orders and schedule</p>
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          Haven't applied yet?{' '}
          <Link href="https://apply.plushintentions.com" className="text-plush-600 font-medium hover:underline">
            Apply Now
          </Link>
        </p>
      </div>
